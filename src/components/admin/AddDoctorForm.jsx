...
import './AddDoctorForm.css'; // Import CSS for styling
  ...
  return (
    <div className="add-doctor-page">
      ...
      <form onSubmit={handleSubmit} className="add-doctor-form">
        ...
        <button className="bg-indigo-500 text-white hover:bg-indigo-600 submit-button" type="submit" >Add Doctor</button>
      </form>
    </div>
  );
}
